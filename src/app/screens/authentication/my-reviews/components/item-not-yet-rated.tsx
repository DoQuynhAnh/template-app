...
export const ItemNotYetRated = () => {
  const [t] = useTranslation();

  // state
  const [listSelected, setListSelected] = useState<Array<TagComment>>([]);
  ...
  return (
    <Block padding={16} colorTheme={'background'}>
      <Block direction="row" middle>
        <Block width={64} height={64} borderRadius={4} overflow={'hidden'}>
          <Image
            source={
      ...
      <Input
        ...
        // labelT18n="my_reviews:detail_rate"
        // typeInput="default"
        multiline
