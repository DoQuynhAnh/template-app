...
var _useScreenReader = require("./useScreenReader");
Object.keys(_useScreenReader).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _useScreenReader[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _useScreenReader[key];
    }
  });
});
