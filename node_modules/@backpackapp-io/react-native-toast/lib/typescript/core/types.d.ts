...
export type ToastAnimationConfig = (WithSpringConfig & WithTimingConfig) & {
    duration?: number;
...
export type ToastOptions = Partial<Pick<Toast, 'id' | 'icon' | 'accessabilityMessage' | 'duration' | 'position' | 'styles' | 'height' | 'width' | 'customToast' | 'disableShadow' | 'providerKey' | 'isSwipeable' | 'animationConfig' | 'animationType'>>;
